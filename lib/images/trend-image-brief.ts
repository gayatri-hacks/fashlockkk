...
const PRESETS: Record<string, BriefPreset> = {
  ...
  oversized: {
    visualSubject: "off-centre close study of an oversized shirt or jacket with exaggerated dropped shoulders, sleeve volume and extra-wide body",
    category: "silhouette_or_fit",
    ...
    constructionDetails: ["exaggerated dropped shoulder", "extra-wide body", "large sleeve volume", "overscale collar with no visible inner tag area"],
    requiredVisualCues: ["oversized proportions", "off-centre close study", "exaggerated sleeve volume", "extra-wide silhouette"],
    forbiddenVisualCues: ["regular slim shirt", "blanket", "curtain", "visible inner collar tag area", "sewn label", "size tab", "brand patch", "imitation writing", "complete centred ecommerce shirt"],
  },
  tailored: {
  ...
  layering: {
    visualSubject: "clearly separate real garments overlapping naturally with distinct collars, hems, sleeves and edges",
    ...
    constructionDetails: ["distinct overlapping collars", "separate sleeve edges", "independent hem lines", "believable seam intersections", "material contrast"],
    requiredVisualCues: ["clearly separate garments", "distinct collars hems sleeves and edges", "natural overlap", "believable material contrast", "asymmetric editorial arrangement"],
    forbiddenVisualCues: ["single flat fabric", "identical beige pieces", "fused garment", "impossible seams", "hybrid clothing object", "centred product catalogue layout"],
  },
  cropped: {
